...
I'm a research fellow in Statistics at the [University of Milano - Bicocca](https://en.unimib.it/), [Department of Economics, Management and Statistics](https://dems.unimib.it/en). 

I'm a passionate R user and author of two R `r emoji::emoji("package")`(s): [`osmextract`](https://cran.r-project.org/package=osmextract) and [`sfnetworks`](https://cran.r-project.org/package=sfnetworks). 

If you want to read more details, check my webpage: [https://agila5.github.io/](https://agila5.github.io/)
...
All the R code can be found here: https://github.com/sfnetworks/SICSS-Covenant
...
- 9.35 - 9.45: Showcase the main pre-processing functions
- 9.45 - 10.15: Live demo. Check the code at [sfnetworks-demo.R](https://github.com/sfnetworks/SICSS-Covenant/raw/main/sfnetworks-demo.R) 
- 10.15 - 10.30: Q&A or additional examples
...
knitr::include_graphics("https://raw.githubusercontent.com/tidyverse/tidyverse/main/man/figures/logo.png")
```
...
```{r, echo = FALSE, out.width="45%"}
knitr::include_graphics("https://github.com/thomasp85/tidygraph/raw/master/man/figures/logo.png")
```
...
knitr::include_graphics("https://github.com/luukvdmeer/sfnetworks/raw/master/man/figures/logo.png")
```
]
...
Now we will present a few basic concepts and simple examples using R code. Let's switch to [sfnetworks-demo.R](https://github.com/sfnetworks/SICSS-Covenant/raw/main/sfnetworks-demo.R)
...
We also developed several more tools to analyse spatial networks such as **graph and spatial morphers**, **graph and spatial filters** or **routing tools**. 
...
knitr::include_graphics("https://4.bp.blogspot.com/_OXpMnfxUDqE/R_GrYYCT1EI/AAAAAAAAABY/GbElkcspz6Q/s400/logo.jpg")
```
]
]
